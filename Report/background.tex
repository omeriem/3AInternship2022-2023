...
\subsubsection{Time and frequency domain}
...
Figure 1. Sigal in frequency domain
\end{center}
...
\subsubsection{Window Functions}
 ...
 In order to solve spectral leakage window functions are used. Window functions are mathematical functions that are zero outside a chosen interval. They are used to truncate the time of the signal, so that it doesn't cause spectral leakage. The following are some examples of window functions:
 \begin{center}
 \includegraphics[scale = 0.2]{images/window_functions.png} \\
 Figure 3. Window functions
 \end{center}

In signal processing, window functions are used to reduce spectral leakage and noise from signals.
...
\\Figure 5. ECG waves specification
