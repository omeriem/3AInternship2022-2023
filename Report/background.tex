...
%Do not forget that we are particularly working on IoT domain application and specifically on signal synchronisation for healthcare use case (EEG and ECG).
  \begin{itemize}
      ...
      \item One important aspect of Iot, especially for health-care Iots, is clock synchronisation. 
      ...
      \begin{itemize}
        ...
        \item One example of an Iot implementation a real-time
        ...
        hardwares, platforms, and programming languages for Iot creation. 
...
{\color{red} You have to introduce the table!}
