 ...
 *   <li>{@link Domain.DomainFramework#getSetups <em>Setups</em>}</li>
...
public interface DomainFramework extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>Setups</b></em>' containment reference list.
	 * The list contents are of type {@link Domain.Setup}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Setups</em>' containment reference list.
	 * @see Domain.DomainPackage#getDomainFramework_Setups()
	 * @model containment="true"
	 * @generated
	 */
