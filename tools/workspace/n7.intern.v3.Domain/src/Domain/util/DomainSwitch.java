...
public class DomainSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DomainPackage.DOMAIN_FRAMEWORK: {
				DomainFramework domainFramework = (DomainFramework)theEObject;
				T result = caseDomainFramework(domainFramework);
			...
			case DomainPackage.FUNCTION_VALUE: {
				FunctionValue functionValue = (FunctionValue)theEObject;
				T result = caseFunctionValue(functionValue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DomainPackage.MARKER: {
			...
			case DomainPackage.FUNCTION_MARKER: {
				FunctionMarker functionMarker = (FunctionMarker)theEObject;
				T result = caseFunctionMarker(functionMarker);
				if (result == null) result = caseMarker(functionMarker);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DomainPackage.ASSIGNATION_MARKER: {
				AssignationMarker assignationMarker = (AssignationMarker)theEObject;
				T result = caseAssignationMarker(assignationMarker);
				if (result == null) result = caseMarker(assignationMarker);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DomainPackage.SETUP_BLOCK: {
				SetupBlock setupBlock = (SetupBlock)theEObject;
				T result = caseSetupBlock(setupBlock);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseDomainFramework(DomainFramework object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Function Value</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Function Value</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseFunctionValue(FunctionValue object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Function Marker</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Function Marker</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseFunctionMarker(FunctionMarker object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Assignation Marker</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Assignation Marker</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAssignationMarker(AssignationMarker object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Setup Block</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Setup Block</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSetupBlock(SetupBlock object) {
		return null;
	}
