...
/**
 * This is the item provider adapter for a {@link iDSL.DataFlow} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataFlowItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addDataflowdescriptorPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataFlow_streams_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataFlow_streams_feature", "_UI_DataFlow_type"),
				 IDSLPackage.Literals.DATA_FLOW__STREAMS,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Dataflowdescriptor feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addDataflowdescriptorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataFlow_dataflowdescriptor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataFlow_dataflowdescriptor_feature", "_UI_DataFlow_type"),
				 IDSLPackage.Literals.DATA_FLOW__DATAFLOWDESCRIPTOR,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 IDSLPackage.Literals.DATA_FLOW__NAME,
				 true,
				 false,
				 false,
