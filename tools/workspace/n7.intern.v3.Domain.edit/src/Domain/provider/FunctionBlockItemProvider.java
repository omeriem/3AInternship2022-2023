...
/**
 * This is the item provider adapter for a {@link Domain.FunctionBlock} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FunctionBlockItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FunctionBlock_parameters_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FunctionBlock_parameters_feature", "_UI_FunctionBlock_type"),
				 DomainPackage.Literals.FUNCTION_BLOCK__PARAMETERS,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		return getString("_UI_FunctionBlock_type");
	}
