...
public class FunctionMarkerItemProvider extends MarkerItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DomainPackage.Literals.FUNCTION_MARKER__BLOCK);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(FunctionMarker.class)) {
			case DomainPackage.FUNCTION_MARKER__BLOCK:
		...
		newChildDescriptors.add
			(createChildParameter
				(DomainPackage.Literals.FUNCTION_MARKER__BLOCK,
				 DomainFactory.eINSTANCE.createFunctionBlock()));
	}
