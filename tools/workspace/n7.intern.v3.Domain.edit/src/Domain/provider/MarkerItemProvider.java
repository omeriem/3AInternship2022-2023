...
/**
 * This is the item provider adapter for a {@link Domain.Marker} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MarkerItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DomainPackage.Literals.MARKER__NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		MarkerID labelValue = ((Marker)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Marker.class)) {
			case DomainPackage.MARKER__NAME:
