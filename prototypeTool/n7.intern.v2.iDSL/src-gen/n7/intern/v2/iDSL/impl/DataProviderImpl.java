 ...
 * </p>
 * <ul>
 *   <li>{@link n7.intern.v2.iDSL.impl.DataProviderImpl#getConnections <em>Connections</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataProviderImpl extends ComponentImpl implements DataProvider {
	/**
	...
	protected EClass eStaticClass() {
		return IDSLPackage.Literals.DATA_PROVIDER;
	}
	...
	public EList<Connection> getConnections() {
		if (connections == null) {
			connections = new EObjectContainmentEList<Connection>(Connection.class, this,
					IDSLPackage.DATA_PROVIDER__CONNECTIONS);
		}
		return connections;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case IDSLPackage.DATA_PROVIDER__CONNECTIONS:
